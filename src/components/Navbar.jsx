          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <Link className="link nav-link tablinks " aria-current="page" to="/" >Ana Səyfə</Link>
              </li>
              <li className="nav-item drop-contain ">
                <Link className="link nav-link tablinks " to="oyunlar" role="button" data-bs-toggle="dropdown" aria-expanded="false" >
              ...
              <li className="nav-item">
                <Link className="link nav-link tablinks" to="haqqimizda">Haqqımızda</Link>
              </li>
